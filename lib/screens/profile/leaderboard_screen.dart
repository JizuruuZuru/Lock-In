            ...
            child: Padding(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  // Every game writes to this collection through the shared
                  // updateLeaderboardEntry() helper, so no game-name allowlist
                  // is needed here — filtering by name silently drops any game
                  // (or newly added lesson) whose name isn't on the list.
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final timeStr = timestamp != null
                                ...
                                : '';
                            final subtitleText = difficulty == null
                                ? '$game • $timeStr'
                                : '$game • $difficulty • $timeStr';
